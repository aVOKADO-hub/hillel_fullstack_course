 ...
 * #3
 *
 * Створіть функцію myPow(a, b, myPrint). Всередині реалізуйте рекурсію для підрахунку результату 
 * піднесення числа a до ступеня b.
...
const myMul = function (a) { return a * this }
...
const DOUBLE = 2
const myDouble = myMul.bind(DOUBLE)
...
const TRIPLE = 3
const myTriple = myMul.bind(TRIPLE)
